...
public class Denuncia {
    ...
    @ManyToOne
    @JoinColumn(name ="org_id",nullable = false) // Usa assim pois é chave estrangeira
    private Orgao orgao;
    ...
    @OneToOne (mappedBy = "denuncia",optional = true)// aqui é relação 1 para 1, pois uma denuncia vai ter um feedback
